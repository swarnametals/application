        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" id="housing_allowance" name="housing_allowance" class="form-control" value="{{ old('housing_allowance', $employee->housing_allowance) }}" required>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="transport_allowance">Transport Allowance<span class="text-danger">*</span></label>
                    <input type="number" id="transport_allowance" name="transport_allowance" class="form-control" value="{{ old('transport_allowance', $employee->transport_allowance) }}" required>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" id="lunch_allowance" name="lunch_allowance" class="form-control" value="{{ old('lunch_allowance', $employee->lunch_allowance) }}" required>
                </div>
            </div>
        </div>
